...
- **English / i18n: LIVE (SV + EN).** Weglot removed; replaced by an **embedded SV→EN dictionary** (`assets/i18n.js`) plus **source-level English** in our own builders. SV/EN switcher (top-right) auto-detects browser language; the choice persists in `localStorage('thlang')` and **reloads**. See §3.5 + Lessons 27–30. (Supersedes Lesson 17.)
