...
- **Welcome email** (`api/join.js`): English, raw founder voice ("You're in.", from William, "What happens now", referral-leaderboard teaser), new blue logo (hosted PNG), List-Unsubscribe. Subject "You're in.", from `Tablehopp <hej@tablehopp.app>`.
