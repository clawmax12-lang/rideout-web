...
(function(){
  ...
  var lang=(function(){var l=null;try{l=localStorage.getItem("thlang");}catch(e){}
    if(l==="en"||l==="sv")return l;return "sv"; /* default SV — EN only by explicit choice (Googlebot must index Swedish) */})();
  ...
  try{if(lang==="en"&&document.documentElement)document.documentElement.classList.add("th-en");document.documentElement.lang="en";}catch(e){}
