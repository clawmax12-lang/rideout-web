...
"""
import os, re, hashlib, html as htmllib, concurrent.futures, urllib.request, ssl
_CTX=ssl.create_default_context(); _CTX.check_hostname=False; _CTX.verify_mode=ssl.CERT_NONE

ROOT = "/tmp/habitline-local"
...
SITE_BASE = "https://framerusercontent.com/sites/7gp38v0CLUWI8Wdmp7kstT/"
...
def fetch(u):
    try:
        with urllib.request.urlopen(urllib.request.Request(u, headers=UA), timeout=60, context=_CTX) as r:
            return r.read()
